            ...
            <div className="bg-slate-800 border border-slate-600 rounded-xl shadow-2xl w-full max-w-lg p-6 animate-fade-in-up">
                ...
                <div className="space-y-6">
                    ...
                    >
                        ...
                        />
                        {file ? (
                            <div className="text-sky-300 font-bold">{file.name}</div>
                        ) : (
                            <>
                                <span className="text-3xl mb-2">📄</span>
                                <span className="text-sm text-slate-400">Nhấn để chọn file truyện (.txt)</span>
                            </>
                        )}
                    </div>
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        >
                            {isProcessing ? <Loader message="Đang xử lý..." /> : "Vào Game"}
                        </button>
                    </div>
                </div>
            </div>
